...
//declaring a variable named "secret" but not assigning any value
//declaring another variable named "code" and giving the value 123
//if statement checking if "code" is equal to 123 so the "secret" variable will be assigned the value "super" and code will be the assigned the value of 123 * 2 (246)
//another if statement, if "code" is greater than 250, the secret variable will be assigned the value "duper"
//console will out the value of secret (super)
